<%@ Page Language="VB" MasterPageFile="~/Forms/Plantilla.master" AutoEventWireup="false" CodeFile="parametro_inventario.aspx.vb" Inherits="Forms_parametro_inventario" title="Página sin título" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td class="style15">
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <asp:TextBox ID="txtbodega" runat="server" Width="350px"></asp:TextBox>
                    <cc1:AutoCompleteExtender ID="txtbodega_AutoCompleteExtender" runat="server" 
                DelimiterCharacters="" Enabled="True" ServicePath="~/autocompletar.asmx" 
                TargetControlID="txtbodega" ServiceMethod="ObtListabodega" 
    ...
    CellPadding="4" CssClass="Alinear_GridVief" AutoGenerateSelectButton="True">
