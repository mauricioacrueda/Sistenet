<%@ Page Language="VB" MasterPageFile="~/Forms/Plantilla.master" AutoEventWireup="false" CodeFile="BuscarCotizacionReporte.aspx.vb" Inherits="Forms_ViewerCotizacion" title="Página sin título" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" Height="50px" ReportSourceID="CrystalReportSource1" 
        Width="350px" DisplayGroupTree="False" />
    <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
        <Report FileName="Reportes\Reporte_CotizacionT.rpt">
        </Report>
