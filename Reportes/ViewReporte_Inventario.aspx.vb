...
Partial Class Reportes_ViewReporte_Inventario
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        rpt.Load(Server.MapPath("Reporte_Inventario.rpt"))
        Me.CrystalReportViewer1.ReportSource = rpt

        p2.ParameterFieldName = "idInventario"
        p3.Value = Integer.Parse(Request.QueryString("IdInventario"))
