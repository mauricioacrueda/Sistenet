...
Partial Class Reportes_ViewReporte_Bodega
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        rpt.Load(Server.MapPath("Reporte_Bodega.rpt"))
        Me.CrystalReportViewer1.ReportSource = rpt

        p2.ParameterFieldName = "idBodega"
        p3.Value = Integer.Parse(Request.QueryString("IdBodega"))
